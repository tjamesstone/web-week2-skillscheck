...
let groceries = ['Chocolate Milk', 'Sour Patch', 'Whipped Cream']
...
//////////////////STEP 4////////////////////
//Create a function called 'addItem' that takes in one paramter called item. Add the item param to the end 
//of the groceries array created above. Inside of addItem, invoke displayData() which is a function we created that 
