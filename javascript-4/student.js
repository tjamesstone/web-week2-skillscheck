...
let faveColors = ['green', 'blue', 'grey']
...
let me = {
    firstname: "Tate", 
    superHeroName:"The Lightning Strike", 
    homeTown: "Midway", 
    superPowers:['Flight', 'Strength', 'Knowledge'], 
...
let trueColors = faveColors.slice(0, 3)
    for(i=0; i < trueColors.length; i++){
    if(trueColors[i] === "blue"){
        i = '#4D4DFF'
    }
}
